...
const Skills = () => {
  ...
  return (
    <section ref={skillsRef} id="skills" className="px-6 md:px-16 py-20 bg-[#0f172a] text-white">
      <motion.h2
      ...
      <motion.p
        ...
        className="text-center max-w-2xl mx-auto mb-14 text-gray-300"
      >
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-6xl mx-auto">
        {skills.map((skill, index) => (
          <motion.div
            ...
            className="skill-card bg-[#1e293b] p-6 rounded-2xl flex flex-col items-center shadow-lg hover:shadow-teal-400/40 transition duration-300 border border-white/5 hover:border-teal-400/30"
          >
            <motion.div
