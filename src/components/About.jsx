...
const About = () => {
  return (
    <section id="about" className="px-6 md:px-16 py-20 bg-[#0b1220] text-white">
      <motion.h2
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="bg-[#1e293b] p-6 rounded-2xl border border-white/5">
            <h3 className="text-xl font-semibold text-teal-400 mb-3">What I Do</h3>
          ...
          <div className="bg-[#1e293b] p-6 rounded-2xl border border-white/5">
            <h3 className="text-xl font-semibold text-teal-400 mb-3">My Approach</h3>
            <ul className="text-gray-300 space-y-2">
