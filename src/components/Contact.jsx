            ...
            <form className="space-y-6">
              <div>
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full px-4 py-3 bg-[#1e293b] border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-teal-400 focus:ring-1 focus:ring-teal-400 transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  name="message"
                  rows="5"
                  className="w-full px-4 py-3 bg-[#1e293b] border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-teal-400 focus:ring-1 focus:ring-teal-400 transition-colors resize-none"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full bg-linear-to-r from-teal-500 to-cyan-500 text-black font-semibold py-3 px-6 rounded-lg hover:from-teal-400 hover:to-cyan-400 transition-all duration-300 shadow-lg hover:shadow-teal-400/30"
              >
                Send Message
              </motion.button>
            </form>
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              >
                ...
                <p className="text-sm text-gray-400">Indore, MP, India</p>
              </motion.a>
            </div>
          </motion.div>
        </div>
